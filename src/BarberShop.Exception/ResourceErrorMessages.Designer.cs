...
namespace BarberShop.Exception {
    ...
    public class ResourceErrorMessages {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Revenues must be for past dates.
        /// </summary>
        public static string REVENUES_FOR_PAST_DATES {
            get {
                return ResourceManager.GetString("REVENUES_FOR_PAST_DATES", resourceCulture);
            }
        }
